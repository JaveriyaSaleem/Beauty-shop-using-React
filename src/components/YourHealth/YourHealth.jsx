...
const YourHealth = () => {
  return (
    <main className='bg-[#FFF8F6] flex md:flex-row flex-col-reverse gap-3'>
        {/* col 1  */}
    <div className='Jost-reg flex flex-col gap-2 p-4  md:gap-5 md:mt-12 items-center'>
      ...
      <div><button className='border-[1px] border-[#F6623E] text-[14px] md:text-[17px] rounded-lg py-2 px-3 hover:border-none hover:text-white hover:bg-[#F6623E]'>BROWSE OUR RANGE</button></div>
    </div>
    {/* col-2  */}
    <div className=''>
